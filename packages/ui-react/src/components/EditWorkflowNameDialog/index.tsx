    ...
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <div
          ...
          <div className="sdk:text-[var(--sdk-color-text-primary)] sdk:text-[13px] sdk:font-normal sdk:font-geist sdk:max-w-[200px] sdk:overflow-hidden sdk:text-ellipsis sdk:whitespace-nowrap">
            {defaultName}
          </div>
          <Edit />
        </div>
