      ...
      <>
        ...
        <foreignObject
          ...
          <button
            ...
            className="sdk:bg-[#141415] sdk:relative sdk:text-[#6F6F6F] sdk:border sdk:border-[#303030] sdk:rounded-[4px] sdk:p-1 sdk:w-6 sdk:h-6 sdk:flex sdk:items-center sdk:justify-center sdk:cursor-pointer">
